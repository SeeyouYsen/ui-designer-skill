...
| 图标 SVG 文件生成与引用（via svgr） | [icon-library.md](./references/icon-library.md) |
...
| 3 | 生成图标 SVG 文件 | [icon-library.md](./references/icon-library.md)、[artifact-structure.md](./references/artifact-structure.md) |
...
- `src/index.css`（`@import "tailwindcss"` + `:root {}` CSS 变量）
